// components/InvoiceImageRenderer.tsx
...
interface InvoiceImageRendererProps {
  order: Order;
  paperWidth: "58" | "80";
...
/**
 * This component renders the invoice image off-screen and captures it for printing
 * Usage:
 *
 * <InvoiceImageRenderer
 *   order={order}
 *   paperWidth="58"
 *   onImageReady={(bytes) => {
 ...
 * />
 */
export const InvoiceImageRenderer: React.FC<InvoiceImageRendererProps> = ({
  order,
  paperWidth,
  onImageReady,
  onError,
  ...
  useEffect(() => {
    const captureImage = async () => {
      try {
        ...
        const raw: any = await captureRef(viewRef, {
          format: "raw",
          result: "base64",
        });
        ...
        const rasterBytes = convertImageToRasterBytes(raw.base64, pixelWidth);
  ...
  return (
    <View style={{ position: "absolute", left: -9999, top: -9999 }}>
      <InvoiceImage ref={viewRef} order={order} paperWidth={paperWidth} />
    </View>
  );
};
